...
- Lập trình mạng, giao thức và kiến trúc hệ thống phân tán  
- Java & JavaScript, xây dựng ứng dụng backend/frontend  
- Lập trình phần mềm, web, C++, React

### Kỹ năng

- **Ngôn ngữ:** Java, JavaScript, C++  
- **Mảng chính:** Network Programming, Web Development  
- **Công cụ:** Git (GitHub, GitLab), Docker  
